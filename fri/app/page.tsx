...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-[#0f1219] text-white overflow-x-hidden">
      ...
      {/* Hero with dot-grid — matches Intercom's section style */}
      <div
      ...
      >
        <div className="max-w-5xl mx-auto px-6 py-20">
          <p className="text-xs uppercase tracking-widest text-[#e8651a] font-medium mb-4">
            Resolution Intelligence
          </p>
          <h1 className="text-[42px] font-bold tracking-tight leading-[1.1] mb-5 text-white max-w-2xl">
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="py-12 border-b border-white/[0.07]">
          <p className="text-white/30 text-xs uppercase tracking-widest mb-6">Customer signal from G2</p>
          <div className="space-y-5">
            <p className="text-white/65 text-sm leading-relaxed border-l-2 border-[#e8651a]/60 pl-4">
              ...
              <span className="text-white/25 ml-2">- Mid-market customer</span>
            </p>
            <p className="text-white/40 text-sm leading-relaxed border-l-2 border-white/[0.1] pl-4">
        ...
        {/* What it does */}
        <div className="py-12 border-b border-white/[0.07] grid grid-cols-1 sm:grid-cols-3 gap-x-10 gap-y-8 text-sm">
          <div>
            <div className="w-1.5 h-1.5 rounded-full bg-[#e8651a] mb-3" />
            <p className="text-white/80 font-medium mb-2">Failure classification</p>
          ...
          <div>
            <div className="w-1.5 h-1.5 rounded-full bg-[#e8651a] mb-3" />
            <p className="text-white/80 font-medium mb-2">Resolution rate audit</p>
          ...
          <div>
            <div className="w-1.5 h-1.5 rounded-full bg-[#e8651a] mb-3" />
            <p className="text-white/80 font-medium mb-2">Prioritised fix playbook</p>
        ...
        <div className="py-12 max-w-lg mx-auto">
          <div className="border border-white/[0.08] rounded-xl bg-white/[0.02] p-6">
            {!isAnalysing ? (
              <>
                <UploadZone
                ...
                <div className="mt-4 text-center">
                  <button
                    ...
                    className="text-white/30 hover:text-white/55 text-sm transition-colors"
                  >
                ...
                {conversations && (
                  <div className="mt-5">
                    <div className="flex items-center justify-between p-3 rounded-lg bg-white/[0.03] border border-white/[0.07] mb-4">
                      ...
                      <span className="text-[#e8651a] text-sm">✓</span>
                    </div>

                    <button
                      onClick={handleAnalyse}
                      className="w-full py-2.5 px-5 rounded-lg bg-[#e8651a] hover:bg-[#d45915] text-white font-medium text-sm transition-colors duration-150"
                    >
              ...
              <div className="flex flex-col items-center py-10 gap-4">
                <Loader2 className="w-5 h-5 text-[#e8651a] animate-spin" />
                ...
                <div className="w-40 bg-white/[0.06] rounded-full h-px mt-1">
                  <div
                    className="bg-[#e8651a] h-px rounded-full transition-all duration-700"
                    style={{
